...
vaseat: [
    ...
    {
        img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:A Nd9GcRJ02n143xyK-8iVNKwDgGdsP_Hu_9IWF5ILKSxf6lzIwskvXpCyDBm_gYli7QZThTVgLQ&usqp=CAU",
...
var targetDiv = document.getElementById("chairs");

var capitalizedBrand = brand[0].toUpperCase() + brand.substring(1);
document.getElementById("brand-heading").innerText = `${capitalizedBrand} Brand`;
document.title = `Richfield chairs | ${capitalizedBrand} brand chairs`;

if(brandData[brand]) {
    brandData[brand].forEach((chair, index) => {
        targetDiv.innerHTML += `
        <div class="content">
  ...
  targetDiv.innerHTML = "<p>No chairs found for this brand.</p>";
}
